            ...
            <div className="max-w-[680px] mx-auto flex items-center gap-0 bg-violet-500/10 border border-violet-500/30 rounded-[18px] px-4 py-1 focus-within:border-violet-500/70 focus-within:shadow-[0_0_0_3px_rgba(139,92,246,0.1)] transition-all">
              ...
              {searchQuery && (
                <button
                  ...
                  className="bg-none border-none cursor-pointer text-violet-400 p-1 flex items-center"
                >
                  <X size={16} />
                </button>
              )}
        ...
        <div className="max-w-7xl mx-auto px-6 pb-8">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2.5">
              <span className="text-[#6b5a8e] text-xs font-semibold">
                Sort:
              </span>
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20">
          {loading ? (
            ...
            <div className="text-center py-24">
              ...
              />
              <h3
                className="text-[1.8rem] font-black text-white mb-2.5"
                  ...
                  >
                    ...
                    <div className="relative overflow-hidden">
                      <img
                        src={pkg.imageUrls?.[0]}
                        alt={pkg.title}
                        className="w-full h-[220px] object-cover block hover:scale-[1.07] transition-transform duration-700"
                      />
