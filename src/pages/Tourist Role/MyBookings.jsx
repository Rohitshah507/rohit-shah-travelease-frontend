        ...
        <div className="flex-1 p-5 md:p-6 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="font-mono text-xs text-violet-400 bg-violet-500/10 px-2 py-0.5 rounded-md border border-violet-500/20 truncate max-w-[200px]">
                {booking._id}
              </span>
            </div>
          </div>
            ...
            {!loading && bookings.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
                {[
                  ...
                  >
                    <div
                      className={`text-[2.2rem] font-black leading-none bg-gradient-to-r ${color} bg-clip-text text-transparent mb-1`}
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {value}
                    </div>
                    <div className="text-[#6b5a8e] text-xs font-semibold">
                      {label}
                    </div>
                  </div>
                ))}
            ...
            <div className="flex flex-wrap gap-2">
              {filterButtons.map(({ id, label, count }) => (
                ...
                >
                  {label}
                  <span
                    className={`px-1.5 py-0.5 rounded-full text-[0.6rem] font-black ${statusFilter === id ? "bg-white/20 text-white" : "bg-violet-500/20 text-violet-400"}`}
                  >
                    {count}
                  </span>
                </button>
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20">
          {loading ? (
            ...
            <div className="text-center py-24">
              ...
              <h3
                className="text-[1.8rem] font-black text-white mb-3"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                No Bookings Yet
              </h3>
              ...
              >
                <Plane size={16} /> Browse Tour Packages{" "}
