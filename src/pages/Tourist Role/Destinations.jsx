  ...
  return (
    <div className="min-h-screen bg-[#07030f] text-white font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-5%] left-[15%] w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle,rgba(139,92,246,0.16)_0%,transparent_70%)] blur-[70px]" />
        <div className="absolute top-[50%] right-[-5%] w-[380px] h-[380px] rounded-full bg-[radial-gradient(circle,rgba(109,40,217,0.12)_0%,transparent_70%)] blur-[80px]" />
        <div className="absolute bottom-[5%] left-[5%] w-[300px] h-[300px] rounded-full bg-[radial-gradient(circle,rgba(76,29,149,0.14)_0%,transparent_70%)] blur-[80px]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-12">
          <div className="flex gap-3.5 items-center p-4 rounded-[22px] border border-violet-500/30 shadow-[0_0_40px_rgba(139,92,246,0.15)] bg-gradient-to-br from-[#1a0a3e] to-[#120630]">
            <div className="flex-1 flex items-center gap-2.5 bg-violet-500/8 border border-violet-500/25 rounded-[18px] px-4 focus-within:border-violet-500/70 transition-colors">
              <Search size={18} className="text-violet-500 ml-2 shrink-0" />
              <input
                type="text"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="flex-1 bg-transparent outline-none text-white text-sm py-3 placeholder:text-violet-400/45"
                placeholder="Search destinations, cities, or countries..."
              />
            </div>
            <button className="px-8 py-3.5 rounded-[16px] font-bold text-sm text-white bg-gradient-to-r from-violet-500 to-violet-700 shadow-[0_4px_15px_rgba(139,92,246,0.4)] hover:shadow-[0_8px_25px_rgba(139,92,246,0.6)] hover:scale-[1.02] transition-all border-none cursor-pointer whitespace-nowrap">
              Search Now
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20">
          ...
          {!loading && filteredDestinations.length > 0 && (
            <div className="text-center mt-14">
              <button className="inline-flex items-center gap-2.5 px-10 py-3.5 rounded-full font-bold text-sm text-violet-300 bg-transparent border-2 border-violet-500/40 hover:bg-violet-500/15 hover:border-violet-500/70 hover:-translate-y-0.5 transition-all cursor-pointer">
                View More Destinations <ArrowRight size={18} />
              </button>
            </div>
          )}
        </div>
