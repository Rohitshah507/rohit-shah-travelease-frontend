  ...
  return (
    <>
      ...
      <section id="home" className="relative h-screen">
        <div className="absolute inset-0" onClick={() => navigate("/signup")}>
          <img
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center text-white px-6 max-w-4xl">
            <p className="text-amber-400 text-sm md:text-base mb-4 tracking-widest uppercase">
              Discover the Ancient Wonders
            </p>
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-200 max-w-2xl mx-auto">
              Immerse yourself in breathtaking landscapes, ancient temples, and
              vibrant cultures that have captivated travelers for centuries
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the most breathtaking locations that showcase the natural
              beauty and cultural heritage of Asia
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {destinations.map((dest, index) => (
              <div key={index} className="group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl mb-4 h-80" onClick={() => navigate("/login")}>
                  <img
                    src={dest.image}
                    alt={dest.title}
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-96 rounded-2xl overflow-hidden" onClick={() => navigate("/signup")}>
              <img
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Experience the vibrant festivals, traditional ceremonies, and
                time-honored customs that have been passed down through
                generations. From lantern festivals to temple celebrations,
                every moment is a journey into the heart of Asian culture.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    Participate in traditional tea ceremonies and cultural
                    workshops
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    Witness spectacular lantern festivals and night celebrations
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <span className="text-gray-700">
                    Connect with local communities and learn ancient crafts
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600">
                Local experts who bring history and culture to life
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-600">
                Carefully curated experiences for unforgettable memories
              </p>
            </div>
          </div>
        </div>
